                ...
                array(
                    ...
                    'categories'     => array(
                        'taxonomy-slug'       => array(
                            ...
                            'nonces'                 => $lrp_string_translation->get_nonces_for_type( 'taxonomy-slug' ),
                        ...
                        'term-slug'           => array(
                            ...
                            'plugin_path'            => LRP_IN_SP_PLUGIN_DIR,
                            'nonces'                 => $lrp_string_translation->get_nonces_for_type( 'term-slug' ),
                            'table_columns'          => array(
                        ...
                        'post-type-base-slug' => array(
                            ...
                            'plugin_path'            => LRP_IN_SP_PLUGIN_DIR,
                            'nonces'                 => $lrp_string_translation->get_nonces_for_type( 'post-type-base-slug' ),
                            'filters'                => array()
                        )
                    )
                )
