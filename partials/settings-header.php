<?php
    $full_logo = LRP_PLUGIN_URL . 'assets/images/tp-logo-with-text-dark.svg';
    $small_logo = LRP_PLUGIN_URL . 'assets/images/tp-logo.png';
?>

<div id="lrp-settings-header">
    <div class="lrp-settings-logo">
        <h2 style="margin: 0; font-size: 24px; font-weight: 600; color: #1e3a5f;">LinguaPress</h2>
    </div>

    <div id="lrp-header-items-wrapper">
        <a class="lrp-header-link" href="https://github.com/dratzymarcano/linguapress/issues">
            <svg class="lrp-header-link-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="lrp-header-item-text lrp-primary-text">Support</span>
        </a>
        <a class="lrp-header-link" href="https://github.com/dratzymarcano/linguapress">
            <svg class="lrp-header-link-icon" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="lrp-header-item-text lrp-primary-text">Documentation</span>
        </a>
    </div>
</div>
